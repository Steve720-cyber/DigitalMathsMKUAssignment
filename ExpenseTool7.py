...
def open_fuel_window():
    ...
    type = ["Select", "Lunch", "Main Meal", "Miscellaneous"]

    # Selected option variable
    opt = StringVar(value="")

    # Dropdown menu
    OptionMenu(fuel_window, opt, *type).pack(pady = 20)

    # Button to update label
    Button(fuel_window, text="Confirm", command=show).pack()

    lbl = Label(fuel_window, text=" ")
    lbl.pack()
