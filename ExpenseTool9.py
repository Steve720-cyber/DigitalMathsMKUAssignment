...
class BudgetTrackerApp:
    ...
    def add_entry(self):
        ...
        #print(date, description, amount, entry_type)
...
#     fuel_window.geometry("250x150")
#
#     #Label(fuel_window, text="Fuel Claim").pack(pady=20)
#
#     def show():
#         lab1.config(text=opt.get())
#         lab2.config(text=opt2.get())
#
#         # Dropdown options
#
#     type = ["Select", "Lunch", "Main Meal", "Misc"]
#     type2 = ["Select", "Lunch", "Main Meal", "Misc"]
#
#     # Selected option variable
#     opt = StringVar(value="")
#     opt2 = StringVar(value="")
#
#     # Dropdown menu
#     options1 = OptionMenu(fuel_window, opt, *type).grid(row=2, column=4)
#     options2 = OptionMenu(fuel_window, opt2, *type2).grid(row=4, column=4)
#
#     # Button to update label
#     option_button = Button(fuel_window, text="Confirm", command=show).grid(row=2, column=5)
#     option2_button = Button(fuel_window, text="Confirm", command=show).grid(row=4, column=5)
#
#     lab1 = Label(fuel_window, text=" ")
#     lab1.grid(row=2, column=6)
#
#     lab2 = Label(fuel_window, text=" ")
#     lab2.grid(row=3, column=6)
#
