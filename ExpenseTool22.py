...
#===============================================================================================================
    ...
    def view_entries():
        ...
        for index, row in df.iterrows():
            ...
            edit_button = Button(top, text="Edit", command=lambda i=index: edit_entry(i))
            delete_button = Button(top, text="Delete", command=lambda i=index: delete_entry(i))
            text.window_create(END, window=edit_button)
            text.window_create(END, window=delete_button)
            text.insert(END, "\n\n")

    def edit_entry(top, index):
        global df
